                    ...
                    <Row>
                        <Col xs={12}>
                            <div className="bg-white p-3 p-md-5">
                                ...
                                <hr className="hr-black my-4" />
                                <p className="text-lg">To request House Seats for Disney's THE LION KING in London please click the button below.</p>
                                <div className="py-0">
                                <a href="https://tickets.disney.co.uk/tickets/houseseats/TLKHOUSE?refId=cacC" class="btn btn--red my-4 no-interstitial-check">REQUEST HOUSE SEATS</a>
                                </div>
