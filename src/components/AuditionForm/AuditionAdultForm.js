...
class AuditionAdultForm extends Component {
            ...
            {this.state.success ? (
                ...
                <>
                    <Form onSubmit={(e) => this.handleSubmit(e)} noValidate ref={this.form}>
                        ...
                        <FormGroup>
                            <Label for="file1">Headshot:* <span className="text-sm">(Max, 2mb, jpg, jpeg, gif, bmp, png)</span></Label>
...
export default AuditionAdultForm